...
assert(html.includes('<h1>Ohio Mountain Bike Trail Conditions</h1>'), 'New site title is missing');
assert(html.includes('<div class="header-updated">Updated <span id="updated">–</span></div>'), 'Last-refreshed time is not in the header');
