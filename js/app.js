...
async function loadSharedData(){
 try{
  let trailRows;
  try{
   trailRows=await supabaseRpc('get_trails_in_bounds',{p_west:-88.2,p_south:37,p_east:-74.5,p_north:42.2,p_state:null,p_limit:500});
