...
async function loadSharedData(){
 try{
  const [trailRows]=await Promise.all([supabaseRpc('get_ohio_trails'),refreshCommunityReports()]);
...
async function fetchTrail(t){
  ...
  const soilProfile=soilProfiles[t.id]||null;
