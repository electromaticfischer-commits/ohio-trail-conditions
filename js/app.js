...
async function loadSharedData(){
 try{
  let trailRows;
  try{
   trailRows=await supabaseRpc('get_trails_in_bounds',{p_west:-85.2,p_south:38.2,p_east:-80.2,p_north:42.2,p_state:null,p_limit:500});
